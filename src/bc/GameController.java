...
public class GameController {
  ...
  public ResearchInfo researchInfo() {
    ...
    return (cPtr == 0) ? null : new ResearchInfo(cPtr, false);
  }
  ...
  public StartGameMessage startGame(Player player) {
    ...
    return (cPtr == 0) ? null : new StartGameMessage(cPtr, false);
  }

  public TurnApplication applyTurn(TurnMessage turn) {
    long cPtr = bcJNI.GameController_applyTurn(swigCPtr, this, TurnMessage.getCPtr(turn), turn);
    return (cPtr == 0) ? null : new TurnApplication(cPtr, false);
  }

  public InitialTurnApplication initialStartTurnMessage() {
    long cPtr = bcJNI.GameController_initialStartTurnMessage(swigCPtr, this);
    return (cPtr == 0) ? null : new InitialTurnApplication(cPtr, false);
  }
